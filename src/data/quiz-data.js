...
const QUESTION_DATA = [
  {
    ...
    answers: [
      <span>L'an 0 avant CC (Christ Cosmique)</span>,
      <span>1989</span>,
      <span>1979</span>,
      <span>1981</span>
    ],
  ...
  },
  {
    ...
    answers: [
      <span>Sylvain Pierre Durif est le Grand Monarque annoncé par les prophéties de Nostradamus et Saint-Malachie,
        dernier roi de France, dernier Pape Pierre officiellement auto-proclamé depuis le 6 juin 2013 ( 666 ) devant le Vatican et avatar du Christ relié aux énergies de l’Homme Vert alias Merlin l’enchanteur et aux énergies Elohims sous son nom d’Ab Ar Ra Am.</span>,
      <span>Tu dis ?</span>,
      <span>L'oeuf cosmique n'est que la représentation de ton imagination. Redscend stp</span>,
      <span>Non</span>
    ],
    correct: 0
  },
  {
    ...
    answers: [
      <span>L'oeuf</span>,
      <span>La poule</span>,
      <span>Gouroux a dit un jour "L'oeuf ou la poule ? CodeCodeCodec"</span>,
    ],
    correct: 2
  },
  {
    question: <span>Que se passe-t-il si tu tapes "do a barrel roll" sur google ?</span>,
    answers: [
      <span>La page tourne sur elle même</span>,
      <span>La page affiche les résultats "do a barrel roll"</span>,
      <span>La page tourne sur elle même sans s'arrêter et nous démontre que la terre est plate</span>,
      <span>Le christ cosmique apparaît</span>
    ],
    correct: 0
  },
  {
    question: <span>Sur AlloCiné, que se passe-t-il lorsqu'on s'inscrit et qu'on tape une date de naissance future ?</span>,
    answers: [
  ...
  },
  {
    ...
    answers: [
      ...
      <span>Non ca n'existe pas à cette époque</span>,
    ],
    correct: 0
  },
  {
    question: <span>Sur Android, dès que 100 onglets sont ouverts que se passe-t-il ?</span>,
    answers: [
      <span>Le nombre d'onglet est remplacé par :D</span>,
      <span>Le nombre d'onglet est numéroté</span>,
